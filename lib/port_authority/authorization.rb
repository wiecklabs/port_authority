        ...
        queue_hook(
          lambda do |controller|
            ...
            if request.session[:force_password_update]  
              ...
              response.message("error force_password", PortAuthority::force_password_update_message)
            ...
            if request.session[:user_invitation_url]
              response.message("error", "You must fill out your registration form before continuing")
