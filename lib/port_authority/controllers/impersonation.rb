...
PortAuthority::Session.register_event_handler(:user_logging_out) do |context|
  context.response.redirect! "/impersonation/deactivate" if context.request.session.impersonating?
end